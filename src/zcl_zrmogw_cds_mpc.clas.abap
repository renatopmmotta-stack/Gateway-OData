class ZCL_ZRMOGW_CDS_MPC definition
  public
...
public section.
  ...
  types:
    begin of TS_ZRMOCDS_VOOTYPE.
      include type ZRMOCDS_VOO.
  types:
    end of TS_ZRMOCDS_VOOTYPE .
  types:
   TT_ZRMOCDS_VOOTYPE type standard table of TS_ZRMOCDS_VOOTYPE .
  ...
  constants GC_ZRMOCDS_VOOTYPE type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'ZRMOCDS_VooType' ##NO_TEXT.
...
CLASS ZCL_ZRMOGW_CDS_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZRMOGW_CDS_SRV' ).
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20260422222441'.                  "#EC NOTEXT
...
*&---------------------------------------------------------------------*
*    @@TYPE_SWITCH:
    CONSTANTS: co_gen_date_time TYPE timestamp VALUE '20260423032441'.
    TRY.
  ...
  method IF_SADL_GW_MODEL_EXPOSURE_DATA~GET_MODEL_EXPOSURE.
    CONSTANTS: co_gen_timestamp TYPE timestamp VALUE '20260423032441'.
    DATA(lv_sadl_xml) =
   ...
   ro_model_exposure = cl_sadl_gw_model_exposure=>get_exposure_xml( iv_uuid      = CONV #( 'ZRMOGW_CDS' )
