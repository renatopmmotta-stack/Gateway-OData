class ZCL_ZRMOGW_VOOS_CDS_MPC definition
  public
...
CLASS ZCL_ZRMOGW_VOOS_CDS_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZRMOGW_VOOS_CDS_SRV' ).
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20260422214356'.                  "#EC NOTEXT
...
*&---------------------------------------------------------------------*
*    @@TYPE_SWITCH:
    CONSTANTS: co_gen_date_time TYPE timestamp VALUE '20260423024357'.
    TRY.
  ...
  method IF_SADL_GW_MODEL_EXPOSURE_DATA~GET_MODEL_EXPOSURE.
    CONSTANTS: co_gen_timestamp TYPE timestamp VALUE '20260423024357'.
    DATA(lv_sadl_xml) =
